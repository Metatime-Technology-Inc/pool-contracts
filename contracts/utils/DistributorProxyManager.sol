...
contract DistributorProxyManager is Ownable2StepUpgradeable {
  ...
  function createPoolProxy(
    ...
    bytes memory _initializationCalldata =
      abi.encodeWithSignature(
        "initialize(address,string,address,uint256,uint256,uint256,uint256,uint256)",
          _msgSender(),
          poolName,
          token,
          startTime,
