...
contract PoolFactory is Ownable2Step {
  ...
  event DistributorCreated(address creatorAddress, address distributorAddress, uint256 distributorId); // Event emitted when a Distributor contract is created.
  event TokenDistributorCreated(address creatorAddress, address tokenDistributorAddress, uint256 distributorId); // Event emitted when a TokenDistributor contract is created.
